[![Run App MalcolmSaltzman](https://github.com/msaltzman5/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/msaltzman5/GithubActions/actions/workflows/run-app.yaml)
